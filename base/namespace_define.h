...
#define BASE_EVENT_BUS base::eventbus
#define BEGIN_NAMESPACE_EVENT_BUS BEGIN_NAMESPACE(base) BEGIN_NAMESPACE(eventbus)
#define END_NAMESPACE_EVENT_BUS END_NAMESPACE() END_NAMESPACE()


#define BASE_AUTH base::auth
#define BEGIN_NAMESPACE_AUTH BEGIN_NAMESPACE(base) BEGIN_NAMESPACE(auth)
#define END_NAMESPACE_AUTH END_NAMESPACE() END_NAMESPACE()
